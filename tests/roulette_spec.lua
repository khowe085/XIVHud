...
describe("mount availability", function()
  --[[ A mount slot is unusable for the 60 seconds after a summon (Kevin,
       2026-08-29). The cooldown is tracked here because nothing in
       get_ability_recasts() carries it - there is no mount ability at all
       in the job_abilities resource. There is no zone rule: the zones
       resource's `can_mount` is missing from too many mountable zones to
       read its absence as a no (Kevin, live client, 2026-09-13). ]]
